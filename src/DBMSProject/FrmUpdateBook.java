 ...
 */
public class FrmUpdateBook extends javax.swing.JDialog {
    ...
    public void setBook(Book std) {
        currentBook = std;
        txtBookTitle.setText(std.getsTitle());
        txtBookAuthor.setText(std.getsAuthor());
    String bsPages = txtPageNumber.getText();
    if (!bsPages.isEmpty()) {
        int pages = Integer.parseInt(bsPages);
        txtPageNumber.setText(String.valueOf(pages));
    }
        //Set selected class
        scs.forEach(ch->{
    ...
    public FrmUpdateBook(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        //Populate combobox
        populateData();
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtBookAuthor, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(62, 62, 62)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(cbxCohort, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addContainerGap())
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(layout.createSequentialGroup()
                    .addContainerGap()
                    ...
                    .addComponent(txtBookTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap()))
        );
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        int ret = new BookHandler().updateBook(currentBook.getbId(), bTitle, bAuthor, bPages, chId);
        if(ret==1){
            doClose(RET_OK);
        }else{
